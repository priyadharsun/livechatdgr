...
public class SwiftLivechatdgrPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "livechatdgr", binaryMessenger: registrar.messenger())
    let instance = SwiftLivechatdgrPlugin()
